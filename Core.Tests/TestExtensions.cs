...
namespace Core.Tests
{
    public static class TestExtensions
    {
        ...
        public static Exception ShouldBeThrownBy(this Type exceptionType, Core.Tests.ExceptionAssert.ExceptionDelegate testDelegate)
        {
            return ExceptionAssert.Throws(exceptionType, testDelegate);
            // Assert.ex
        ...
        /// <param name="actual"></param>
        /// <param name="expected"></param>
        public static void AssertContainsStringAs(this string actual, string expected)
        {
